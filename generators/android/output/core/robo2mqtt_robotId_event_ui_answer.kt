 ...
 *
 * Capability: robo2mqtt/{robotId}/event/ui/answer
 */
class Robo2mqttRobotIdEventUiAnswerCapability(
    ...
    fun handleCommand(command: String, payload: String?) {
        when (command) {
            else -> mqtt.publishError("Unknown command '$command' in robo2mqtt/{robotId}/event/ui/answer")
        }
    }
}
